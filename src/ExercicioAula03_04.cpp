// Este exemplo apresenta uma aplicação completa de OpenGL, que renderiza um pentagono na tela.
#include <iostream>
#include <glad/glad.h>
...
void inicializaObjetos() {
    ...
    // No caso deste exemplo, vamos renderizar somente 1 pentagono, logo, precisamos somente de
    ...
    // Definição de um VBO para os vértices do pentagono
    // - Primeiramente, definimos em um vetor de float os vértices do pentagono;
    ...
    float points[] = {
       // triângulo cima
		0.0f, 1.0f, 0.0f,      //vertice cima
		0.2f, 0.7f, 0.0f,     //vertice direito
		-0.2f, 0.7f, 0.0f,    //vertice esquerdo
		//triângulo esquerda
		-0.2f, 0.7f, 0.0f,    //vertice cima
		-0.4f, 0.4f, 0.0f,      //vertice esquerdo
		0.0f, 0.4f, 0.0f,     //vertice direito
        //triângulo direita
		0.2f, 0.7f, 0.0f,     //vertice cima
		0.0f, 0.4f, 0.0f,      //vertice esquerdo
		0.4f, 0.4f, 0.0f,     //vertice direito
    };
    ...
    // Definição de um VBO para as cores do pentagono. Observe que passamos como parâmetro o valor 1
...
void inicializaRenderizacao() {
    ...
    while (!glfwWindowShouldClose(Window)) {
        ...
        // Desenhamos o pentagono especificado no vao
